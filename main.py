        ...
        <body>
            ...
            <script>
                async function connectWallet() {
                    const sessionString = "your_session_string"; // Replace with actual session string generated from WalletConnect
                    const deepLink = `wc:${sessionString}`;

                    // Open the deep link to connect to MetaMask
